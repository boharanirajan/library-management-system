...
{ 
    ...
    $sql="SELECT student.usename, student.roll, books.bid, books.name,
     books.authors,books.edition, issue_book.Issue,issue_book.return_date
      FROM student INNER JOIN issue_book ON student.usename=issue_book.username INNER JOIN 
      books ON issue_book.bid =books.bid
    WHERE issue_book.approve='Yes' ORDER BY `issue_book`.`return_date` ASC";
