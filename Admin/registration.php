...
<script>
    function validateForm() {
        ...
        if (first === "" || last === "" || usename === "" || password === "" || 
         email === "" || contact === "") {
       ...
       <?php
          if(isset($_POST['submit']))
          {
            include "connection.php";
            $count=0;
            $mysql= "SELECT usename from admin";
            ...
            $sql = "INSERT INTO admin values ('$_POST[first]', '$_POST[last]'
            ,'$_POST[usename]','$_POST[password]','$_POST[email]',
            '$_POST[contact]','p.png')";
