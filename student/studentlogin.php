...
<body>
    ...
    <section style="background-image: url(images/3.jpg);">
         <div class="log_img">
            ...
            <div class="box1">
                ...
                <p style="color: white;">
                    <a style="color:White; margin-left: 70px; text-decoration:
                     none; " href="update_password.php">Forgot password? 
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp; &nbsp;&nbsp;&nbsp;</a>
    ...
    {
        $count=0;
     $res =mysqli_query($db, "SELECT * FROM `student` WHERE usename='$_POST[usename]'
